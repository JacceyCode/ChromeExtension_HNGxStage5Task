...
function Hero() {
  return (
    <section className="bg-white">
      <section className="laptop:px-[6.25rem] laptop:py-32 laptop:justify-start tablet:gap-4 m-auto flex w-full max-w-[90rem] flex-wrap items-center justify-center gap-20 px-4 py-16">
